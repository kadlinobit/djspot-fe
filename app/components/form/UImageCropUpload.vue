<template>
    <div class="space-y-4">
        ...
        <div
            ...
            :class="{ 'border-primary-500 bg-primary-50 dark:bg-primary-950/20': isDragging }"
...
function processFile(selectedFile: File) {
    ...
    modelValue.value = { file: selectedFile };
...
function onCroppedImageChange(croppedImage: CropperResult) {
    modelValue.value = { file: file.value, croppedImage };
}
